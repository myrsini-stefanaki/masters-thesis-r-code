...
read file and save as a data frame
```{r}
...
re-scale and normalize news valence
```{r}
...
Robustness check removing the zero values from reddit comments 
*I didn't include it in thesis but it confirmed my results
